...
using Content.Client.SS220.Zone.UI.CustomControls;
...
public sealed partial class ZoneEditor : PanelContainer
{
    ...
    private readonly ZoneSystem _zones = default!;
    ...
    private void OnLayoutEnded(IBoxLayoutManager.BoxArgs boxArgs)
    {
        ...
        newArea = SharedZoneSystem.OptimizeArea(newArea);
    ...
    private static ZoneArgs GetZoneArgs(Entity<ZoneComponent>? ent, IEntityManager? entityManager = null)
    {
        ...
        return new ZoneArgs()
        {
            ...
            ProtoId = metaData?.EntityPrototype?.ID ?? SharedZoneSystem.DefaultZoneProtoId,
    ...
    private bool ChangeArgs(ActionRefZoneArgs action, bool refresh = true, bool recalculate = false)
    {
        ...
        if (recalculate)
            args.Area = SharedZoneSystem.OptimizeArea(args.Area);
    ...
    public struct ZoneArgs()
    {
        ...
        public EntProtoId<ZoneComponent> ProtoId = SharedZoneSystem.DefaultZoneProtoId;
