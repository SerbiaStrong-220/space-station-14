...
namespace Content.Client.SS220.Zone.UI.CustomControls;
...
public sealed partial class ZonePrototypeSelectorPopup : Popup
{
    ...
    private readonly ZoneSystem _zonesSystem;

    public Action<EntityPrototype>? OnPrototypeSelected;

    private List<EntityPrototype> _prototypes = [];
    ...
    public ZonePrototypeSelectorPopup()
    {
        ...
        _zonesSystem = _entityManager.System<ZoneSystem>();
    ...
    {
        _prototypes = [.. _zonesSystem.EnumerateZonePrototypes().Where(x => !x.Abstract)];
        SortPrototypes();
    }
