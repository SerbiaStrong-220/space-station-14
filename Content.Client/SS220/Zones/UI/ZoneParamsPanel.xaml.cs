...
public sealed partial class ZoneParamsPanel : PanelContainer
{
    ...
    private ZoneParams _newParams = default!;
    ...
    private void InitInteractions()
    {
        ...
        ParentNetIDLineEdit.OnFocusExit += args => SetContainer(args.Text);
        ParentNetIDLineEdit.OnTextEntered += args => SetContainer(args.Text);
        ...
        AttachToLatticeCheckbox.OnPressed += _ => SetAttachToGrid(AttachToGridCheckbox.Pressed);
