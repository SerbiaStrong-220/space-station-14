...
public sealed partial class ZoneParamsPanel : PanelContainer
{
    ...
    {
        NameLabel.ToolTip = Loc.GetString("zone-state-box-name-tooltip");
        PrototypeIDLabel.ToolTip = Loc.GetString("zone-state-box-prototype-id-tooltip");
        HexColorLabel.ToolTip = Loc.GetString("zone-state-box-hex-color-tooltip");
        ContainerNetIDLabel.ToolTip = Loc.GetString("zone-state-box-container-net-id-tooltip");
        AttachToGridCheckbox.ToolTip = Loc.GetString("zone-state-box-attach-to-grid-tooltip");
        CutSpaceOptionLabel.ToolTip = Loc.GetString("zone-state-box-cut-space-option-tooltip");
    }
