...
namespace Content.Client.SS220.Communications.UI
{
    ...
    {
        private CluwneCommunicationsConsoleBoundUserInterface Owner { get; set; }
        private readonly CancellationTokenSource _timerCancelTokenSource = new();

        public CluwneCommunicationsConsoleMenu(CluwneCommunicationsConsoleBoundUserInterface owner)
        {
