...
public sealed partial class SupaMicrowaveWindow : DefaultWindow
{
    ...
    public SupaMicrowaveWindow(SupaMicrowaveBoundUserInterface owner)
    {
        ...
        for (var i = 0; i <= 30; i += 5)
        {
            ...
            {
                Text = i == 0 ? Loc.GetString("supa-microwave-menu-instant-button") : i.ToString(),
                CookTime = (uint) i,
