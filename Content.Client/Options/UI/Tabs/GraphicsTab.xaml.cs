    ...
    public GraphicsTab()
    {
        ...
        Control.AddOptionDropDown(
            ...
            [
                ...
                //SS220-ui-scale-options begin
                new OptionDropDownCVar<float>.ValueOption(0.8f, Loc.GetString("ui-options-scale-80")),
                new OptionDropDownCVar<float>.ValueOption(0.85f, Loc.GetString("ui-options-scale-85")),
                new OptionDropDownCVar<float>.ValueOption(0.9f, Loc.GetString("ui-options-scale-90")),
                new OptionDropDownCVar<float>.ValueOption(0.95f, Loc.GetString("ui-options-scale-95")),
                //SS220-ui-scale-options end
                ...
                new OptionDropDownCVar<float>.ValueOption(1.1f, Loc.GetString("ui-options-scale-110")),
                new OptionDropDownCVar<float>.ValueOption(1.15f, Loc.GetString("ui-options-scale-115")),
                new OptionDropDownCVar<float>.ValueOption(1.2f, Loc.GetString("ui-options-scale-120")),
                //SS220-ui-scale-options end
                new OptionDropDownCVar<float>.ValueOption(1.25f, Loc.GetString("ui-options-scale-125")),
                //SS220-ui-scale-options begin
                new OptionDropDownCVar<float>.ValueOption(1.3f, Loc.GetString("ui-options-scale-130")),
                new OptionDropDownCVar<float>.ValueOption(1.35f, Loc.GetString("ui-options-scale-135")),
                new OptionDropDownCVar<float>.ValueOption(1.4f, Loc.GetString("ui-options-scale-140")),
                ...
                new OptionDropDownCVar<float>.ValueOption(1.6f, Loc.GetString("ui-options-scale-160")),
                new OptionDropDownCVar<float>.ValueOption(1.65f, Loc.GetString("ui-options-scale-165")),
                new OptionDropDownCVar<float>.ValueOption(1.7f, Loc.GetString("ui-options-scale-170")),
                //SS220-ui-scale-options end
                new OptionDropDownCVar<float>.ValueOption(1.75f, Loc.GetString("ui-options-scale-175")),
                //SS220-ui-scale-options begin
                new OptionDropDownCVar<float>.ValueOption(1.8f, Loc.GetString("ui-options-scale-180")),
                new OptionDropDownCVar<float>.ValueOption(1.85f, Loc.GetString("ui-options-scale-185")),
                new OptionDropDownCVar<float>.ValueOption(1.9f, Loc.GetString("ui-options-scale-190")),
