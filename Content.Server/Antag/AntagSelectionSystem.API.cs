...
public sealed partial class AntagSelectionSystem
{
    ...
    public int GetTargetAntagCount(Entity<AntagSelectionComponent> ent, int? playerCount, AntagSelectionDefinition def)
    {
        ...
        return Math.Clamp((poolSize - countOffset + (int)(def.PlayerRatio * def.PlayerPerAntagAdjustmentMultiplayer)) / def.PlayerRatio, def.Min, def.Max); // SS220-give-more-flex-to-antag-selection
    }
