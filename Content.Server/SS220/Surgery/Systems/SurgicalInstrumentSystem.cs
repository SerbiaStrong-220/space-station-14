...
namespace Content.Server.SS220.Surgery.Systems
{
    public sealed partial class SurgicalInstrumentSystem : EntitySystem
    {
        ...
        {
            var instrumentPopup = component.Mode == SurgicalInstrumentMode.SELECTOR ? "Выбор зоны операции" : "Оперирование";
        ...
        public void OnAfterInteractEvent(EntityUid uid, SurgicalInstrumentComponent component, AfterInteractEvent args)
        {
            ...
            if (component.Mode == SurgicalInstrumentMode.SELECTOR) 
                PopulateLimbSelector(args.User, target, args.Used);
        }
