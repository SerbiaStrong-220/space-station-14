...
{
    public abstract class SavePersonCondition : IObjectiveCondition
    {
        ...
        /// <summary>
        /// Whether the target must be truly NOT dead, ignores missing evac.
        /// </summary>
        ...
        public string Title
        {
            get
            {
                ...
                if (Target == null)
                    return Loc.GetString("objective-condition-save-person-title", ("targetName", targetName), ("job", jobName));
        ...
        public string Description => Loc.GetString("objective-condition-save-person-description");

        public SpriteSpecifier Icon => new SpriteSpecifier.Rsi(new("Objects/Specific/Medical/firstaidkits.rsi"), "brutekit");
        ...
        public float Progress
        {
            get
            {
                ...
                // Цель сбежала - вы выполнили свою цель
        ...
        {
            return other is SavePersonCondition kpc && Equals(Target, kpc.Target);
        }
        ...
        public override bool Equals(object? obj)
        {
            ...
            return Equals((SavePersonCondition) obj);
        }
