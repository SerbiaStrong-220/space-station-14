...
public sealed class ActivatableUIRequiresVisionSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<HudableComponent, HudChangedEvent>(OnHudChanged);
    }
    ...
    private void OnHudChanged(EntityUid uid, HudableComponent component, ref HudChangedEvent args)
    {
        if (!args.Visible)
            return;
