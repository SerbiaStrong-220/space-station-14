...
public sealed partial class ChatSystem : SharedChatSystem
{
    ...
    private static readonly ProtoId<QuadHearingTargetTypePrototype> QuadHearingTargetProtoId = "Speech";
    private const float QuadHearingTargetSpeechRange = 20f;
    private const float QuadHearingTargetWhisperRange = 14f;
        ...
        )
    {
        ...
        _quadHearing.RegisterTarget(QuadHearingTargetProtoId, source, QuadHearingTargetSpeechRange); // SS220 Quad hearing
        ...
        )
    {
        ...
        // SS220 languages end
        _quadHearing.RegisterTarget(QuadHearingTargetProtoId, source, QuadHearingTargetWhisperRange); // SS220 Quad hearing
