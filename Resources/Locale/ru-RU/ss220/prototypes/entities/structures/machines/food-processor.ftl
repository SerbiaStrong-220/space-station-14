ent-KitchenFoodProcessor = кухонный комбайн
    .desc = Универсальный кухонный комбайн для переработки продуктов. Пальцы лучше держать при себе.
food-processor-popup-busy = Кухонный комбайн уже работает!
