ent-OrigamiBook = Книга Искусства Оригами
    .desc = Книга, с которой путь к Искусству Оригами начинается. Повторное чтение приблизит вас к полному овладению смертельно точным бумажным мастерством.
