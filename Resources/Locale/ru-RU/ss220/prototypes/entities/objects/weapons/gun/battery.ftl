...
ent-WeaponSynergisticEnergyGun = синергетический энергетический пистолет
    .desc = Инновационное оружие, объединяющее в себе передовые технологии и уникальный дизайн. Обладает двумя режимами стрельбы: стандартным и сконцентрированным.
