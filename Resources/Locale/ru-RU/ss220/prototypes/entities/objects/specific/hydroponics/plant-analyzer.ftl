ent-BasePlantAnalyzer = анализатор растений
    .desc = Компактный прибор неразрушающего контроля для получения информации о состоянии, химическом составе и генетических особенностях растений.
...
ent-PlantAnalyzerReportPaper = отчёт анализатора растений
    .desc = Документ с ключевыми параметрами исследуемого образца.
