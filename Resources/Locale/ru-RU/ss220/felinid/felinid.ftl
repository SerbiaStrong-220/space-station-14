...
felinid-pipecrawl-unequip-external = Из трубы нельзя снять чужую экипировку или позволить раздеть себя.
felinid-pipecrawl-unequip-hands-full = Сначала освободите руку, иначе снятый предмет выпадет из трубы.
felinid-pipecrawl-unequip-dependent = Сначала снимите предметы, закреплённые поверх этой экипировки.
