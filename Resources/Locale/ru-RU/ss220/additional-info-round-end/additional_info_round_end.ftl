...
# ANTAG STATS START
additional-info-antag-items-label =
    Предметы, купленные в аплинке:
...
additional-info-economy-categories =
    Экономика и ресурсы
...
# GUN STATS START
additional-info-gun-categories =
    Стрельба
...
# JANITOR STATS START
additional-info-janitor-categories =
    Уборщик
...
# DEATH STATS START
additional-info-death-categories =
    Смерти
