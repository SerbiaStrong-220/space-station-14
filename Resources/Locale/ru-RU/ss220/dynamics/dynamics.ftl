...
dynamic-light-briefing-name = [color=green]Незаметное исполнение[/color]
dynamic-medium-briefing-name = [color=yellow]Умеренный риск[/color]
dynamic-hard-briefing-name = [color=red]Активное столкновение[/color]
