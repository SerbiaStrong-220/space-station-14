...
mindslave-fixer-surgery-guide = Поздравляем Вас с приобретением продукции "Interdyne Pharmaceutics"!
    ...
    Сама операция происходит в несколько этапов:
        ...
        2. Сделайте скальпелем надрез в затылочной части головы
        3. Увеличьте ретрактором рабочую область
        4. При помощи дисковой пилы доберитесь до мозгового импланта
        5. Гемостатом зажмите кровоточащие места
        6. Произведите манипуляции с имплантам
        7. Закройте разрезы прибором для прижигания
