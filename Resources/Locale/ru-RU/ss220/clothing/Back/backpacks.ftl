...
ent-ClothingBackpackEmergencyEVA = аварийный рюкзак "ИШАК"
    .desc = Изделие прошло все испытания, кроме тех, где требовалось сохранить достоинство пользователя. Использовать для тех случаев, когда нужно терпеть, выживать и тащить на себе всё самое необходимое.
