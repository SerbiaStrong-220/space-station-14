...
ent-ClothingUniformJumpskirtBrigDoctorTurtleneck = водолазка бригмедика
    .desc = Профессиональная водолазка для мобильности и защиты на работе. Сочетание комфорта и стиля позволит вам быть готовым к любым испытаниям.
