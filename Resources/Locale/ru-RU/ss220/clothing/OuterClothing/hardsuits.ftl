...
ent-ClothingOuterHardsuitJuggernaut = Силовая броня THCS-002
    .suffix = Ядерный Оперативник
    .desc = Скафандр с бронёй IV класса из пластали и урана, обладающий активным экзоскелетом на базе искуственых мышц и системой гашения заброневого воздействия. Требует нейроинтерфейс для подключения к нервной системе пользователя.
