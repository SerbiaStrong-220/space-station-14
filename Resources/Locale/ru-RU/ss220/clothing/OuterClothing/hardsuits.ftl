...
ent-ClothingOuterHardsuitJuggernaut = Тяжёлый штурмовой скафандр TCH-002
    .suffix = Ядерный Оперативник
    .desc = Скафандр с бронёй IV класса из пластали и урана, обладающий электромеханическим активным экзоскелетом и системой гашения заброневого воздействия.
