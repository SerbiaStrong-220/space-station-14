haloperidol-nitrousoxide-created = Вы видите, как вещество пузырится.
ambuzol-ammonia-created = Смесь начинает странно пахнуть...
dexaline-carbondioxide-created = Смесь пузырится!
