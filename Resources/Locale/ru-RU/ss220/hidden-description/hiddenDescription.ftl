...
ent-AntiDropImplanter = { ent-Implanter }
    .desc = { ent-Implanter.desc }
    .suffix = Анти Дроп

ent-AntiDropImplant = имплант Магнит
    .desc = Микрочип, который вживляют под кожу.

ent-ActionActivateAntiDropImplant = Активировать имплант
    .desc = Активируйте, чтобы предотвратить выпадение предметов из рук при падении или подскальзывании.
...
uplink-anti-drop-implanter-name = Имплант Магнит
uplink-anti-drop-implanter-desc = Имплант, который после активации притягивает предмет к вашей ладони, не позволяя ему выпасть даже при падении или подскальзывании.
# silent shoes
