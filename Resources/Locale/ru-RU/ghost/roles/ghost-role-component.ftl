...
ghost-role-information-syndie-reinforcement-description = Вы натренерованный Агент Синдиката, посланный на задание по помощи другим Агентам. Вам плевать на свою жизнь и вы готовы сделать все, что прикажет вызвавший вас Агент.
...
ghost-role-information-syndie-reinforcement-monkey-name = Обученный Агент Макака Синдиката
