...
ent-StationAiUploadComputer = консоль изменения законов
    .desc = Отображает законы станции и загружает законы с платы для ИИ, киборгов или всех сразу. Требует ID-карту с необходимым доступом.
