...
ent-ClothingMaskGasSyndicate = черный боевой противогаз
    ...
    .desc = Высокотехнологичный противогаз с возможностью подключить ее к баллону, разработанный специально для борьбы в тяжелых условиях! Теперь с функцией защиты для глаз!
