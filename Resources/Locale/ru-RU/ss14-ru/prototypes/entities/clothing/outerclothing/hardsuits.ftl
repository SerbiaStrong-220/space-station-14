...
ent-ClothingOuterHardsuitLuxury = элитный шахтёрский скафандр
    .desc = Отремонтированный шахтёрский скафандр, покрытый золотым напылением, чтобы подчеркнуть ваше благосостояние. Внутренняя часть скафандра дополнена графеновой подкладкой, что облегчила сам скафандр ценой его защитных свойств. <#--SS220 Quartermaster_Hardsuit_add-->
