...
ent-ClothingHandsGlovesNorthStar = пара сине-белых перчаток
    ...
    .desc = Вы чувствуете необычную лёгкость в руках, когда держите их. При их надевании вам хочется сжать пальцы в кулак, будто они должны засиять, как звезда, и невольно сказать: «Omae wa mou shindeiru…» - в то время, когда кто-то уже падёт от вашей руки.
