...
ent-ClothingHandsGlovesIhscombat = боевые перчатки IHS\n  .desc = Эти тактические перчатки обладают определенной огне- и ударопрочностью.

ent-ForensicGloves = перчатки криминалиста\n  .desc = Не оставляют волокон или отпечатков. Если вы работаете без них, вы УЖАСНЫЙ ДЕТЕКТИВ.
