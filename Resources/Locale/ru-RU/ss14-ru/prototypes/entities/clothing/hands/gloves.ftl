...
ent-ClothingHandsGlovesNorthStar = пара сине-белых перчаток
    .suffix = перчатки Полярный звезды
    .desc = Чувствуется какая-то легкость рук, когда держишь их. При одевании их, хочется сжать пальцы в кулак, будто они засияют как звезда, и вы невольно захотите сказать: «Омаева му шиндеру…» — когда кто-то падёт от вашей руки.
