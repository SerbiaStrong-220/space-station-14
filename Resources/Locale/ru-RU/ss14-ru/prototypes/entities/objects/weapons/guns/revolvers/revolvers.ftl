...
ent-WeaponRevolverInspector = Инспектор
    .desc = Револьвер двойного действия, выпускаемый различными производителями. Свободно продаётся на гражданском рынке, из-за чего пользуется популярностью среди частных детективов. Просто держа его в руках чувствуешь, как тебе везёт. Вмещает 6 патронов калибра 11,5x32.
    .suffix = Револьвер
...
ent-WeaponRevolverPython = Питон
    .desc = Мощный револьвер двойного действия, произведённый Синдикатом. Громкий и эффектный, идеально подходит для любого агента, который хочет заявить о себе. Вмещает 6 патронов калибра 11,5x32.
    .suffix = Револьвер
...
ent-WeaponRevolverPirate = пиратский револьвер
    .desc = Простой револьвер одинарного действия, самоделка космического пирата. Старый и покрытый ржавчиной, но почему-то всё ещё работающий. Вмещает 5 патронов калибра 11,5x32.
    .suffix = Револьвер
