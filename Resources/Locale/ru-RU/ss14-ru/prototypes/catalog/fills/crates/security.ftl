...
ent-CrateLaserTagEquipmentRed = ящик для игры в лазертаг(Красная команда)
    .desc = Содержит три красных жилета и комбенизона для игры в лазертаг, а так же 3 тренировочные лазерные винтовки. Чтобы открыть, необходим уровень доступа Служба безопасности.
ent-CrateLaserTagEquipmentBlue = ящик для игры в лазертаг(Синяя команда)
     .desc = Содержит три синих жилета и комбенизона для игры в лазертаг, а так же 3 тренировочные лазерные винтовки. Чтобы открыть, необходим уровень доступа Служба безопасности.
