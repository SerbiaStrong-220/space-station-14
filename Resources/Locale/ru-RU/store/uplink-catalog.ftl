...
uplink-radio-jammer-desc = При активации это устройство блокирует любую исходящую поблизости радиосвязь. Замаскирован под оценочный аппарат.
# Implants
...
uplink-carp-dehydrated-desc = Выглядит как обычная игрушка карпа! Однако стоит добавить воды и тут же он начнет кусать все подряд! Хоть он и не двигается, но все слышит и чувствует.
# Job Specific
...
uplink-nocturine-chemistry-bottle-desc = Высокоэффективное снотворное и гипнотическое средство, разработанное Синдикатом для тайных операций. Билет в один конец в хонкоград. Поставляется в бутылочке на 30u. (Случайно не выпейте, если перепутайте бутылочки.)
...
uplink-syndicate-segway-crate-desc = Алый цвет, красивый и брутальный узор на шинах, стильные диски... вы знаете на чем вы будете уезжать от ядерного взрыва! Будьте врагом корпорации на стиле! Поставляется в ничем непримечательном ящике для перевоза скота.
