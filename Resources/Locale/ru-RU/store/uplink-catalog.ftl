...
#SS220-esword-locale-desс-tweak-begin
uplink-esword-desc = Очень опасный энергомеч, чрезвычайно смертоносен в ближнем бою. В выключенном состоянии может храниться в карманах. Сильно шумит при использовании или включении.
#SS220-esword-locale-desc-tweak-end
uplink-esword-double-name = Двухклинковый энергетический меч
#SS220-desword-locale-desc-tweak-begin
uplink-esword-double-desc = Гораздо более дорогая альтернатива обычному энергетическому мечу: имеет встроенный энергощит с двумя режимами работы, большим углом атаки, более высоким уроном по конструкциям и большей скоростью замаха. Сильно шумит при включении и использовании.
#SS220-dsword-locale-desc-tweak-end
...
#SS220-eshield-locale-desc-tweak-begin
uplink-eshield-desc = Экзотический энергощит, крайне лёгкий и удобный для отражения всех типов атак. Обладает выдающейся прочностью и практически не может быть разрушен стрелковым оружием.
#SS220-eshield-locale-desc-tweak-end
